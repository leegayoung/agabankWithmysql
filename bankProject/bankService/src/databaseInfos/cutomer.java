...
public class cutomer {
	...
	//	j.insetUser("김수한무", "970112-2542341", "010-1234-5678");
	//	j.createAcc("김수한무", "970112-2542341", "010-1234-5678", "500000", 5678, 1234, "200000", "200000");
	...
	//	System.out.println("여기 : "+j.printInfo_balance("1111111-10101010"));
	//	j.balancecheck("1383661-22577205");
		j.typecheck("1383661-22577205", "악세사리");
		//	j.remittance
	}
	...
	public int Depositamount(){
		...
		int amount =0;
		System.out.println("입금 원하시는 금액을 입력하세요 : ");
		amount = scan.nextInt();
		return amount;
	}
}

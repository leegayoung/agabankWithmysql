...
public class Nyounum{
	...
	public Nyounum(){
		...
		JLabel textl = new JLabel("상대방의 계좌번호를 입력해주세요.");
		textl.setFont(font2);
		...
		ipbt.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		    	...
		    	ds.setReceiverAcc(ta.getText());
		    	if(dw.Check_Acc(ds.getReceiverAcc()))
		    	{
		    		ds.setReceiverName(dw.return_Name_Acc_Info(ds.getReceiverAcc()));
		    		//ds.setReceiverName(dw.return_Name_Acc_Info(ds.getMyacc()));
		    		Nmoney Nmoney= new Nmoney();
		    	}
		    	else 
		    	{
